...
## Docker run command
```docker 
docker run -itd --restart=unless-stopped -p 19443:19443 -p 19444:19444 ltc/litecoin:v0.21.2.1 -regtest=1 -server=1 -rpcuser=admin -rpcpassword=123456 -txindex=1 -paytxfee=0.00005 -rpcport=19443 -rpcallowip=0.0.0.0/0 -port=19444 -rpcbind=0.0.0.0:19443
```



## successfully tested result below with the node:
